...
public final class StrikeTriggers {
    ...
    public static final StrikeTrigger STEALING_POSSESSION = StrikeTrigger.create("stealing_possession", Severity.MINOR);
    ...
    public static final StrikeTrigger BREAKING_STRUCTURE = StrikeTrigger.create("breaking_structure", Severity.MINOR); // todo implement
    public static final StrikeTrigger ATTACKING_GUARDIAN = StrikeTrigger.create("attacking_guardian", Severity.MINOR);

    public static final StrikeTrigger KILLING_VILLAGER = StrikeTrigger.create("killing_villager", Severity.MAJOR);
