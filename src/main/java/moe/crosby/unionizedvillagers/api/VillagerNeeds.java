...
public final class VillagerNeeds {
    ...
    public static final VillagerNeed NO_MONSTER_NEARBY = register("no_monster_nearby", NoMonsterNeed::new, 1);
    public static final VillagerNeed NO_HAZARD_NEARBY = register("no_hazard_nearby", NoHazardNearbyNeed::new, 1);
    ...
    public static final VillagerNeed IN_HOME_DIMENSION = register("in_home_dimension", InHomeDimensionNeed::new, 3);
    public static final VillagerNeed WORKSTATION = register("workstation", WorkstationNeed::new, 4);
    public static final VillagerNeed HOME = register("home", HomeNeed::new, 4);
    public static final VillagerNeed NO_ADJACENT_WORKSTATION = register("no_adjacent_workstation", NoAdjacentWorkstationNeed::new, 5);
    public static final VillagerNeed LIGHT = register("light", LightNeed::new, 5);
    ...
    private static VillagerNeed register(String name, VillagerNeedFactory factory, int priority) {
        VillagerNeed need = factory.create(UnionizedVillagersImpl.id(name), priority * 100); // x100 to allow registering needs in between built-in ones
